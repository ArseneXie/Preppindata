from kanren import *
from kanren.core import lall, success, fail, lany
from kanren.goals import heado
...
def notthis(cx, list):
    return fail if not_equalo(membero(cx, list)) else success 
...
clues = lall(
    ...
    (lany, (membero,('ATitle', 'Aname', 'AProd', '1'), customer),
     (membero,('ATitle', 'Aname', 'AProd', '1'), customer),
...
clue2 = lall(
    (eq, (var(), var(), var(), var()), solutions),
    (membero,('CTitle', var(), var(), '1'), solutions)
)

solutions = run(1, solutions, clue2)
